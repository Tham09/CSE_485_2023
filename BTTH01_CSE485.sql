...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 29, 2023 lúc 11:36 AM
...
INSERT INTO `baiviet` (`ma_bviet`, `tieude`, `ten_bhat`, `ma_tloai`, `tomtat`, `ndung`, `ma_tgia`, `ngayviet`, `hinhanh`) VALUES
...
--
ALTER TABLE `baiviet`
  ADD PRIMARY KEY (`ma_bviet`,`ma_tloai`,`ma_tgia`);
